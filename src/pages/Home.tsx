...
{' '}
        ...
        <footer style={{ position: 'relative', overflow: 'hidden', background: 'var(--bg-primary)', borderTop: '1px solid var(--border)', marginTop: '24px' }}>
          ...
          {/* Main grid */}
          <div style={{ position: 'relative', maxWidth: '1100px', margin: '0 auto', padding: '48px 20px 32px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(200px, 100%), 1fr))', gap: '40px', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              {/* Social icons */}
              <div className="footer-social" style={{ display: 'flex', gap: '10px', marginTop: '4px', flexWrap: 'wrap' }}>
                {/* Instagram */}
                <a href="#" aria-label="Instagram" className="s-ig" style={{ width: '44px', height: '44px', background: 'rgb(65,29,131)', borderRadius: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', flexShrink: 0 }}>
                ...
                {/* Twitter/X */}
                <a href="#" aria-label="Twitter" className="s-tw" style={{ width: '44px', height: '44px', background: 'rgb(65,29,131)', borderRadius: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', flexShrink: 0 }}>
                ...
                {/* LinkedIn */}
                <a href="#" aria-label="LinkedIn" className="s-li" style={{ width: '44px', height: '44px', background: 'rgb(65,29,131)', borderRadius: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', flexShrink: 0 }}>
                ...
                {/* WhatsApp */}
                <a href="#" aria-label="WhatsApp" className="s-wa" style={{ width: '44px', height: '44px', background: 'rgb(65,29,131)', borderRadius: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', flexShrink: 0 }}>
